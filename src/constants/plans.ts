...
export const PLANS: PLAN[] = [
    {
        id: "standard",
        title: "Casual Dater",
        desc: "For people testing the waters. Create your DateMeDoc and see if this whole chronically online dating thing actually works.",
        monthlyPrice: 9,
        annuallyPrice: 95,
        buttonText: "Start Dating",
        features: [
            "1 DateMeDoc",
            "Accept up to 20 applications/mo",
            "Basic psychoanalysis matching",
    ...
    },
    {
        id: "mastermind",
        title: "Serial Swiper",
        desc: "For ABGs and chronically online legends who get 100+ boyfriend applications and need the full AI experience.",
        monthlyPrice: 29,
        annuallyPrice: 306,
        badge: "Most Popular",
        buttonText: "Upgrade to Serial Swiper",
        features: [
            "Unlimited DateMeDocs",
            "Unlimited applications",
            "Advanced psychoanalysis AI",
            "Connect all your socials",
            "Priority matching algorithm",
            "Video profile integration",
            "Advanced vibe compatibility",
            "Priority support"
        ],
        link: "#"
    },
