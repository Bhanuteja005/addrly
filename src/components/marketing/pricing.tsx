                ...
                <Container>
                    <div className="flex flex-col items-center text-center max-w-2xl mx-auto">
                        ...
                        <p className="text-base md:text-lg text-center text-accent-foreground/80 mt-6">
                            Whether you're casually looking or ready to become the internet's most eligible bachelor/bachelorette, we got you covered.
                        </p>
                    </div>
                </Container>
...
const Plan = ({ plan, billPlan }: { plan: PLAN, billPlan: Plan }) => {
    return (
        <div className={cn(
            ...
            plan.title === "Serial Swiper" && "border-blue-500"
        )}>
            {plan.title === "Serial Swiper" && (
            ...
            <div className="flex flex-col items-start w-full px-4 py-2 md:px-8">
                <Button size="lg" variant={plan.title === "Serial Swiper" ? "blue" : "white"} className="w-full">
                    {plan.buttonText}
                </Button>
